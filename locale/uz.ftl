...
whatisFullNameOfClient = <b>👤 Mijozning to'liq ismini kiriting:</b>
invalidTextMessage = ❌ Iltimos matn kiriting!
whereFromClient = <b>📋 Mijoz qayerdan keldi?</b>
onOffice = 🏘 Tashrif
onCallCenter = 📞 Call Center
whatIsCarModel = <b>🚗 Avtomobil markasini tanlang:</b>
whatIsPaymentMethod = <b>💳 To'lov turini tanlang:</b>
whatIsWorkplace = <b>💼 Kasbini tanlang:</b>
whatIsAddress = <b>📍 Manzilni tanlang:</b>
whatIsPhoneNumber = <b>📞 Telefon raqamini kiriting:</b>
whatIsStatus = <b>📊 Statusni kiriting:</b>
confirm = ✅ Tasdiqlash
